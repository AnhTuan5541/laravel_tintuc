...
@section('content')
    ...
    <div class="content">
        <h1 >Tin Tức <small>{{$tintuc->Ten}}</small></h1>
        <hr>
        <form action="admin/tintuc/sua/{{$tintuc->id}}" method="post" class="col-md-7" enctype="multipart/form-data">
            @if (count($errors)>0)
            ...
            <div class="form-group">
                ...
                <select class="custom-select" name="idTheLoai" id="theloai" required>
                    <option value="{{$tintuc->loaitin->idTheLoai}}">{{$tintuc->loaitin->theloai->Ten}}</option>
            ...
            <div class="form-group">
                ...
                <select class="custom-select" name="idLoaiTin" id="loaitin" required>
                    <option value="{{$tintuc->idLoaiTin}}">{{$tintuc->loaitin->Ten}}</option>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="Ten" placeholder="Nhập tên tin tức" value="{{$tintuc->Ten}}"/>
            </div>
            <div class="form-group">
                <label>Tóm tắt</label>
                <textarea class="form-control ckeditor" name="TomTat" id="cc" rows ="5"></textarea>
